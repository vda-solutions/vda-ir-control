...
|-------|---------------|------|
| Olimex ESP32-POE-ISO | [`firmware-esp32-poe-iso-v1.2.1.bin`](https://github.com/vda-solutions/vda-ir-control/releases/latest/download/firmware-esp32-poe-iso-v1.2.1.bin) | ~1020 KB |
| ESP32 DevKit (WiFi) | [`firmware-esp32-devkit-wifi-v1.2.1.bin`](https://github.com/vda-solutions/vda-ir-control/releases/latest/download/firmware-esp32-devkit-wifi-v1.2.1.bin) | ~993 KB |

Flash using [esptool](https://github.com/espressif/esptool):
```bash
pip install esptool
esptool.py --chip esp32 --port /dev/ttyUSB0 --baud 921600 \
  write_flash -z 0x0 firmware-esp32-devkit-wifi-v1.2.1.bin
```
...
| Brand | Protocol | Commands |
|-------|----------|----------|
| Pioneer (Generic) | PIONEER | Power, Volume, Mute, HDMI 1-6, Inputs, Surround Modes, Navigation |
| Pioneer Elite | PIONEER | Power, Volume, Mute, HDMI 1-7, Inputs, Surround Modes, Zone 2/3, Navigation |
